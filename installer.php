...
$GLOBALS['FW_URL_OLD'] = 'http://ccuffs.url.ph';
$GLOBALS['FW_URL_NEW'] = 'http://meunovosite/';
$GLOBALS['FW_PACKAGE_NAME'] = 'content_54514620252756931141029195512_archive.zip';
$GLOBALS['FW_PACKAGE_NOTES'] = '';
$GLOBALS['FW_SECURE_NAME'] = 'content_54514620252756931141029195512';
$GLOBALS['FW_DBHOST'] = 'localhost';
$GLOBALS['FW_DBHOST'] = empty($GLOBALS['FW_DBHOST']) ? 'localhost' : $GLOBALS['FW_DBHOST'];
$GLOBALS['FW_DBNAME'] = 'database';
$GLOBALS['FW_DBUSER'] = 'usuario';
$GLOBALS['FW_DBPASS'] = '';
$GLOBALS['FW_SSL_ADMIN'] = 0;
$GLOBALS['FW_SSL_LOGIN'] = 0;
$GLOBALS['FW_CACHE_WP'] = 0;
$GLOBALS['FW_CACHE_PATH'] = 0;
$GLOBALS['FW_BLOGNAME'] = 'Ciência da Computação UFFS';
$GLOBALS['FW_WPROOT'] = '/home/u412213853/public_html/';
